...
class ViTPoseModel(object):
    ...
    def __init__(self, parent_path, device):
        ...
        vitpose_data = os.path.join(parent_path, "_DATA", "vitpose_ckpts")
        self.model_name = 'ViTPose+-G (multi-task train, COCO)'
        self.MODEL_DICT = {
        'ViTPose+-G (multi-task train, COCO)': {
            'config': f'{vitpose_data}/configs/ViTPose_huge_wholebody_256x192.py',
            'model': f'{vitpose_data}/vitpose+_huge/wholebody.pth',
            },
        }
