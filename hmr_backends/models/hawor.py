"""
HaWoR (Hands in the Wild with World-space Recovery) model class.
Derived from HaWoR's lib/models/hawor.py with all imports rewritten
to use the hamer.* package namespace.
"""
...
from hmr_backends.datasets.track_dataset import TrackDatasetEval
from hmr_backends.models.modules import MANOTransformerDecoderHead, temporal_attention
from hmr_backends.utils.pylogger import get_pylogger
from hmr_backends.utils.render_openpose import render_openpose
from hmr_backends.utils.geometry import rot6d_to_rotmat_hmr2 as rot6d_to_rotmat
from hmr_backends.utils.geometry import perspective_projection_hawor as perspective_projection
from hmr_backends.utils.rotation import angle_axis_to_rotation_matrix
...
class HAWOR(pl.LightningModule):
    ...
    # Tensorboard logging should run from first rank only
    ...
    def inference(self, imgfiles, boxes, img_focal, img_center, device, do_flip=False):
