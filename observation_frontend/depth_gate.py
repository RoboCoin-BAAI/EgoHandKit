    ...
    *,
    ...
    for frame_index, (frame, image_path, depth_path) in enumerate(zip(frames, image_paths, depth_paths)):
        ...
        for observation in frame["hands"]:
            ...
            elif depth_m < min_depth_m or depth_m > max_depth_m:
                reasons.append("absolute_depth_limit")
            elif reference is not None and (depth_m / reference > max_ratio or depth_m / reference < min_ratio):
    ...
    summary = {
        ...
        "max_bad_frames": max_bad_frames, "unit_scale": unit_scale, "frames": diagnostics,
